...
class ArticlesController extends Controller
{
    ...
    public function store(ArticleRequest $request)
    {
        ...
        if($request->file('image')) {
            ...
            $name = 'blogCode_'. time() . '.' . $file->getClientOriginalExtension();
        ...
        Flash::success("Se ha creado el Articulo" . " " . $article->name ." "."de forma exitosa");
    ...
    public function destroy($id)
    {
        ...
        Flash::error('se ha borrado el Articulo' . " " . $article->title ." ". 'ha sido borrada con exitos');
        return redirect()->route('articles.index');
    }
}
