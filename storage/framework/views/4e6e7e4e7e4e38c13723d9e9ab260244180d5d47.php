...
<?php $__env->startSection('content'); ?>
	<?php echo Form::open(['route' => ['articles.update', $article],'method' => 'PUT', 'files' => true]); ?>


	<div class="form-group">
		<?php echo Form::label('title','Titulo'); ?>

		<?php echo Form::text('title', $article->title, ['class' => 'form-control', 'placeholder' => 'Titulo del articulo ...', 'required']); ?>

	</div>
	<div class="form-group">
		<?php echo Form::label('category_id', 'Categoria'); ?>

		<?php echo Form::select('category_id', $categories, $article->category->id, ['class' => 'form-control select-category' ,'required']); ?>
	...
	<div class="form-group">
		...
		<?php echo Form::select('tags[]', $tags, $my_tags, ['tags' => 'id', 'class' => 'form-control select-tag','multiple','required']); ?>

	</div>

	<div class="form-group">
		<?php echo Form::submit('Editar Articulos', ['class'=>'btn btn-raised btn-info']); ?>
